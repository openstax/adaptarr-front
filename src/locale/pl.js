export default {
  translations: {
    ...
    "DraftsList.noDraftsFound": "Nie posiadasz żadnych szkiców.",
    "AssignedToMe.noAssigned": "Żaden moduł nie jest do Ciebie przypisany.",
    ...
    "Draft.title.placeholder": "Tytuł szkicu",
    "Draft.title.save.success": "Tytuł został zaktualizowany.",
    "Draft.title.save.error": "Nie udało się zaktualizować tytułu.",
